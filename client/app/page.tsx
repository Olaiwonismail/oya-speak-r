  ...
  const testimonials = [
    {
      ...
      role: "Student, Lagos",
      content:
        "OyaSpeak helped me perfect my English pronunciation while staying connected to my Yoruba roots. The AI feedback is incredibly accurate!",
      rating: 5,
    ...
    },
    {
      ...
      role: "Teacher, Abuja",
      content:
        "I use OyaSpeak to improve my English and Igbo. The progress tracking helps me see real improvement in my pronunciation.",
      rating: 5,
      avatar: "/placeholder.svg?height=40&width=40",
    },
  ]
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">How OyaSpeak Works</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">OyaSpeak</span>
              </div>
